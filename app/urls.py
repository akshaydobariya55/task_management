...
urlpatterns = [
    ...
    path('project_update/<int:id>/',views.projectupdateview,name="updatedata"),
    path('<int:id>/',views.taskupdateview,name="updatetask"),
    path('updatecomment/<int:id>/',views.commentupdateview,name="updatecomment"),
